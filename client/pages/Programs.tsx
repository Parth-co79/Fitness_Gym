  ...
  const programs = [
    {
      ...
      color: "secondary",
      description:
        "Shed pounds and build confidence with our science-backed weight loss program.",
      features: [
    ...
    },
    {
      ...
      color: "primary",
      description:
        "Build lean muscle and transform your physique with progressive strength training.",
      features: [
    ...
    },
    {
      ...
      color: "purple",
      description:
        "Complete lifestyle overhaul: lose fat, gain muscle, boost energy, and feel amazing.",
      features: [
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Whether you have 4 weeks or 12 weeks, we have a program designed
              to deliver real results for your lifestyle.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {programs.map((program) => (
              <div
                key={program.id}
                className="bg-card rounded-2xl border border-border overflow-hidden hover:shadow-2xl transition-all group flex flex-col h-full"
              >
                {/* Header */}
                <div
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Your path to transformation in 4 simple steps
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Take the Quiz",
                description:
                  "Tell us your goal, current fitness level, and available time. We'll recommend the perfect program.",
              },
              {
                step: 2,
                title: "Get Your Plan",
                description:
                  "Receive a personalized workout schedule, meal plan, and daily motivation tailored just for you.",
              },
              {
                step: 3,
                title: "Work Out Smart",
                description:
                  "Follow video-guided workouts, track your progress, and get real-time form feedback.",
              },
              {
                step: 4,
                title: "Transform",
                description:
                  "See results, build consistency, and join thousands who've changed their lives with FitStart.",
              },
            ].map((item) => (
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary via-purple-600 to-secondary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Pick a program above and start your free trial today. No credit card
            required.
          </p>
