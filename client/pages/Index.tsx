            ...
            <div className="space-y-8 animate-slideUp">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-muted-foreground max-w-xl">
                  Feeling lost? Not anymore. We guide students like you
                  step-by-step through personalized fitness programs. No
                  experience needed. Just determination.
                </p>
              </div>
              ...
              <div className="relative h-full flex flex-col items-center justify-center space-y-6 p-8">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground max-w-sm">
                    Join thousands of students who've already taken the first
                    step towards a healthier, stronger life.
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Whether you want to lose weight, gain muscle, or transform your
              entire lifestyle - we have the perfect program waiting for you.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Link
              to="/programs"
              className="bg-gradient-to-br from-card to-card/50 border border-secondary/30 rounded-2xl p-8 shadow-lg hover:shadow-xl hover:border-secondary/60 transition-all group cursor-pointer"
            >
              ...
              <p className="text-muted-foreground mb-6">
                Shed pounds, build confidence, and transform your body. Cardio,
                nutrition, and motivation combined.
              </p>
            ...
            <Link
              to="/programs"
              className="bg-gradient-to-br from-card to-card/50 border border-primary/30 rounded-2xl p-8 shadow-lg hover:shadow-xl hover:border-primary/60 transition-all group cursor-pointer"
            >
              <div className="flex items-center gap-4 mb-6">
              ...
              <p className="text-muted-foreground mb-6">
                Build lean muscle and unleash your strength. Progressive
      ...
      <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Certified fitness professionals who understand students like you.
              Real people, real results, real passion.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link
              to="/trainers"
              className="bg-card rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all group cursor-pointer"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  5+ years transforming students into confident athletes.
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-secondary font-semibold text-sm mb-3">
                  Cardio & Weight Loss Expert
                </p>
                <p className="text-muted-foreground text-sm mb-4">
                  7+ years of helping students lose weight and feel amazing.
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-primary font-semibold text-sm mb-3">
                  Flexibility & Wellness Coach
                </p>
                <p className="text-muted-foreground text-sm mb-4">
                  6+ years helping students prevent injuries and feel balanced.
                  Yoga & mobility expert.
                </p>
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star
      ...
      <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-card/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Affordable pricing. Zero hidden fees. Start free and upgrade
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link
              to="/plans"
              className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-border hover:border-muted cursor-pointer"
            >
            ...
            <Link
              to="/plans"
              className="bg-gradient-to-br from-primary to-purple-600 text-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all relative md:scale-105 cursor-pointer"
            >
            ...
            <Link
              to="/plans"
              className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-primary/30 hover:border-primary/60 cursor-pointer"
            >
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary via-purple-600 to-secondary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Your best self is waiting on the other side of this decision.
            Thousands of students have already transformed their lives. It's
            your turn.
          </p>
