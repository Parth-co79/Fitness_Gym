        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Choose from 30+ classes weekly. All fitness levels welcome. Join
              live or access recordings anytime.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-lg p-8 border border-border text-center">
              ...
              <p className="text-muted-foreground">
                Browse our schedule and find a class that fits your goals and
                schedule.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-8 border border-border text-center">
              ...
              <p className="text-muted-foreground">
                Click "Book Spot" and secure your place. Spots fill up fast!
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-8 border border-border text-center">
              ...
              <p className="text-muted-foreground">
                Get access to the Zoom link and join live, or watch the
                recording later.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary via-purple-600 to-secondary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Book your first class today and join our amazing community of
